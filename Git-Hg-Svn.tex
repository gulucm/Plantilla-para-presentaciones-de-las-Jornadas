...
\begin{document}
    ...
    \section{Control de versiones}
       ...
       \end{frame} 
        \begin{section}{CVCS: Subversion}
        
       \begin{frame}{Subversion} 
       \begin{frame}{Uso básico de svn}
       \begin{frame}{Montar un servidor Subversion}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
        ...
        \begin{section}{DVCS: Git y Mercurial}
        \begin{frame}{Usar git en un repositorio Mercurial y viceversa} 
